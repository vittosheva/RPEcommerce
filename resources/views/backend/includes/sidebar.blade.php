<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <!-- Web Services -->
            <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern('admin/billing*'), 'open') }}">
                <a class="nav-link nav-dropdown-toggle {{ active_class(Active::checkUriPattern('admin/billing*')) }}" href="#">
                    <i class="icon-cursor"></i> Facturas
                </a>

                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link {{ active_class(Active::checkUriPattern('admin/billing/billing-process*')) }}" href="{{ route('admin.billing.index') }}">
                            <i class="icon-cloud-upload"></i> Prestashop facturas
                        </a>
                    </li>
                </ul>
            </li>
